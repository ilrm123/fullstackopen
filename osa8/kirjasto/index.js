...
const resolvers = {
  Query: {
    ...
    allBooks: (root, args) => {
      ...
      if (args.author != undefined && args.genre === undefined) {
        ...
        return books.filter(b => b.author === args.author).filter(b => b.genres.includes(args.genre) === true)
      } else {
        return books
      }
    },
  ...
  Mutation: {
    ...
    editAuthor: (root, args) => {
      ...
      if (authorsArray.includes(args.name) === true) {
        const newAuthor = authors.find(a => a.name === args.name)
        newAuthor.born = args.setBornTo
        const oldAuthor = authors.findIndex(a => a.name === args.name)

        authors[oldAuthor] = newAuthor
        return newAuthor
      }
